      ...
      <section class="main">
        ...
        <div class="main-top">
          ...
          <div class="right" v-if="Object.keys(current_song).length">
            <h4 class="name">
              ...
              <router-link to="/" v-if="current_song.mv" class="label"
                >mv</router-link
              >
            </h4>
            <div
              class="alia"
              v-if="current_song.alia && current_song.alia.length"
            >
              <span v-for="(item, index) in current_song.alia" :key="index">{{
                item.name
              }}</span>
            </div>
            <div class="info">
              <div
                class="album"
                :title="current_song.album.name"
                v-if="current_song.album"
              >
                专辑：
                <router-link
                  :to="`/album/${current_song.album.id}`"
                  class="value"
        ...
        <div class="main-bottom">
          ...
          <div class="right">
            <div
              class="col"
              v-if="!this.current_song.folder && simiPlaylists.length"
            >
              ...
              <ul>
                <li
                  ...
                  :key="playlist.id"
                  class="simi-song"
                  @click="goRoute(playlist)"
                >
                  <img
                    v-lazy="`${playlist.coverImgUrl}?param=40y40`"
                    class="song-avatar"
                  />
                  <div class="song-info">
                    <div class="song-name">{{ playlist.name }}</div>
                    <div class="playcount"
                      >播放次数: {{ playlist.playCount | toWan }}</div
                    >
                  </div>
                </li>
              </ul>
            ...
            <div
              class="col"
              v-if="!this.current_song.folder && simiSongs.length"
            >
      ...
      .left {
        ...
        .avatar-wrapper {
          ...
          .song-avatar {
            ...
            height: 210px;
            border-radius: 50%;
            box-shadow: 0 0 0 8px rgba(0, 0, 0, 0.9);
          }
          .freq {
            position: absolute;
            left: 50%;
