  ...
  <div class="player-wrapper">
    <div class="video-player" @dblclick="toggleFullscreen">
      <transition name="topbar">
        ...
        >
          <div class="topbar">
            <a-button size="small" @click="showMain">打开主界面</a-button>
            <div
          ...
          <div class="video-controls">
            ...
            <div class="video-operation">
              ...
              <div class="right">
                ...
                <div class="brs">
                  <div class="default" @click="showMoreList('br')">{{
                    brsMap[mvURL.key]
                  }}</div>
                </div>
                <div class="speed" @click="showMoreList('speed')">
                  倍速×{{ speed }}
                </div>
      ...
      <div class="mask-with-fixed" v-show="isFixed">
        ...
        />
        <a-icon :type="playIcon" @click="togglePlaying" class="icon-center" />
        <a-icon
          type="close"
          title="关闭"
          @click="close"
      ...
      <a-tabs default-active-key="1" @change="handleTabChange">
        <a-tab-pane key="video" tab="视频">
          <div class="mv-info">
            ...
            <div
              style="display: flex"
              v-if="videoType === 'video' && videoData.videoGroup.length"
            >
              <span
                style="
                  minwidth: 60px;
            ...
            >
            <div class="desc">{{ videoData.desc || "暂无描述" }}</div>
          </div>
          <div class="simi-mv">
